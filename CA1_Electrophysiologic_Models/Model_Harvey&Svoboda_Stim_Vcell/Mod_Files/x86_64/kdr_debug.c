...
extern Memb_func* memb_func;
 ...
 "setdata_k_dr_Bh", _hoc_setdata,
 "mh_k_dr_Bh", _hoc_mh,
 0, 0
};
 /* declare global and static user variables */
#define erest_act erest_act_k_dr_Bh
 double erest_act = -60;
#define ek ek_k_dr_Bh
 double ek = -75;
 ...
 "ek_k_dr_Bh", &ek_k_dr_Bh,
 "erest_act_k_dr_Bh", &erest_act_k_dr_Bh,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 k_dr_Bh /Users/maoss2/NEURON/CA1_cell_test/Stimulation_case_per_case/CA1_Electrophysiologic_Models/CA1_Electrophysiologic_Models/Model_Harvey&Svoboda_Stim_Vcell/Mod_Files/x86_64/kdr_debug.mod\n");
...
static int  mh ( _threadargsprotocomma_ double _lv ) {
 ...
 _lalpha = ( ( 0.016 * ( 35.1 + erest_act ) ) + ( - 0.016 * _lv ) ) / ( - 1.0 + exp ( ( _lv + ( - 1.0 * ( 35.1 + erest_act ) ) ) / - 5.0 ) ) ;
   _lbeta = 0.25 / exp ( ( _lv + ( - 1.0 * ( 20.0 + erest_act ) ) ) / - 40.0 ) ;
