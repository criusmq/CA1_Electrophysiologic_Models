...
extern Memb_func* memb_func;
 ...
 "setdata_k_ahp_Bh", _hoc_setdata,
 "mh_k_ahp_Bh", _hoc_mh,
 0, 0
};
 /* declare global and static user variables */
#define ek ek_k_ahp_Bh
 double ek = -75;
#define erest_act erest_act_k_ahp_Bh
 double erest_act = -60;
 ...
 "erest_act_k_ahp_Bh", &erest_act_k_ahp_Bh,
 "ek_k_ahp_Bh", &ek_k_ahp_Bh,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 k_ahp_Bh /Users/maoss2/NEURON/CA1_cell_test/Stimulation_case_per_case/CA1_Electrophysiologic_Models/CA1_Electrophysiologic_Models/Model_Harvey&Svoboda_Stim_Vcell/Mod_Files/x86_64/K_ahp_debug_Bh.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Potasium AHP type current for Traub/Bhalla ";
...
static int  mh ( _threadargsprotocomma_ double _lcai ) {
   double _lalpha , _lbeta , _lsum ;
 if ( _lcai < ( 0.5 / 2.0 ) ) {
     _lalpha = 0.00002 * _lcai ;
     _lbeta = 0.001 + _lalpha ;
