...
extern Memb_func* memb_func;
 ...
 "setdata_k_c_Bh", _hoc_setdata,
 "settables_k_c_Bh", _hoc_settables,
 0, 0
};
 /* declare global and static user variables */
#define ek ek_k_c_Bh
 double ek = -75;
#define erest_act erest_act_k_c_Bh
 double erest_act = -60;
 ...
 "erest_act_k_c_Bh", &erest_act_k_c_Bh,
 "ek_k_c_Bh", &ek_k_c_Bh,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 k_c_Bh /Users/maoss2/NEURON/CA1_cell_test/Stimulation_case_per_case/CA1_Electrophysiologic_Models/CA1_Electrophysiologic_Models/Model_Harvey&Svoboda_Stim_Vcell/Mod_Files/x86_64/k_c_debug_Bh.mod\n");
...
static int  settables ( _threadargsprotocomma_ double _lv ) {
 ...
 if ( _lv < erest_act + 50.0 ) {
     _lalpha = ( exp ( 0.053872 * ( _lv - erest_act ) - 668.35 ) ) / 18.975 ;
     _lbeta = ( 2.0 * ( exp ( ( erest_act + 6.5 - _lv ) / 27.0 ) ) ) - _lalpha ;
     _lsum = _lalpha + _lbeta ;
     m_inf = _lalpha / _lsum ;
     m_tau = 1.0 / _lsum ;
     }
   else {
     _lalpha = 2.0 * exp ( ( erest_act + 6.5 - _lv ) / 27.0 ) ;
     _lbeta = 0.0 ;
     _lsum = _lalpha + _lbeta ;
     m_inf = _lalpha / _lsum ;
     m_tau = 1.0 / _lsum ;
