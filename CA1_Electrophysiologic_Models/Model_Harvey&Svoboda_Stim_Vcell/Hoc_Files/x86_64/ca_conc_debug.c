...
extern Memb_func* memb_func;
 ...
 "setdata_ca_conc_Bh", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define caiBase caiBase_ca_conc_Bh
 double caiBase = 5e-05;
#define ceiling ceiling_ca_conc_Bh
 double ceiling = 2;
 ...
 "ceiling_ca_conc_Bh", "mM",
 "caiBase_ca_conc_Bh", "mM",
 "phi_ca_conc_Bh", "/ms",
 0,0
};
 ...
 "ceiling_ca_conc_Bh", &ceiling_ca_conc_Bh,
 "caiBase_ca_conc_Bh", &caiBase_ca_conc_Bh,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 ca_conc_Bh /Users/maoss2/NEURON/CA1_cell_test/Stimulation_case_per_case/CA1_Electrophysiologic_Models/CA1_Electrophysiologic_Models/Model_Harvey&Svoboda_Stim_Vcell/Mod_Files/x86_64/ca_conc_debug.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Calcium dynamics cai for Traub/Bhalla";
