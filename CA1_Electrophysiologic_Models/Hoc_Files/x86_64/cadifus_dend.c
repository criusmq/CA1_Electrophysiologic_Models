...
#define ceiling ceiling_cadifus_dend
 double ceiling = 2;
#define kb kb_cadifus_dend
 double kb = 0.1;
#define kf kf_cadifus_dend
 double kf = 1;
 ...
 "kf_cadifus_dend", "/mM-ms",
 "kb_cadifus_dend", "/ms",
 "DCa_cadifus_dend", "um2/ms",
 "DGef_cadifus_dend", "um2/ms",
 "DCaGef_cadifus_dend", "um2/ms",
 "ceiling_cadifus_dend", "mM",
 "caiBase_cadifus_dend", "mM",
 "phi_cadifus_dend", "/ms",
 "ca_cadifus_dend", "mM",
 "cagef_cadifus_dend", "mM",
 "gef_cadifus_dend", "mM",
 0,0
};
 ...
 "kf_cadifus_dend", &kf_cadifus_dend,
 "kb_cadifus_dend", &kb_cadifus_dend,
 "DCa_cadifus_dend", &DCa_cadifus_dend,
 "DGef_cadifus_dend", &DGef_cadifus_dend,
 "DCaGef_cadifus_dend", &DCaGef_cadifus_dend,
...
static void nrn_alloc(Prop* _prop) {
 ...
 "cagef_cadifus_dend", 1e-10,
 "gef_cadifus_dend", 1e-10,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 6);
 	...
 	ivoc_help("help ?1 cadifus_dend /Users/maoss2/NEURON/CA1_cell_test/Stimulation_case_per_case/CA1_Electrophysiologic_Models/CA1_Electrophysiologic_Models/Mod_Files/x86_64/cadifus_dend.mod\n");
